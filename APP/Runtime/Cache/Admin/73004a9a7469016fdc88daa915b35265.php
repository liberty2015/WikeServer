        ...
        <div class="col-1">
            <div class="panel panel-default templatemo-content-widget white-bg no-padding templatemo-overflow-hidden">
                <div class="panel-heading templatemo-position-relative">
                    <h2 class="text-uppercase">LoginLog Table</h2>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered" id="userlist">
                        ...
                        <tbody>
                        <?php if(is_array($log)): $i = 0; $__LIST__ = $log;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                                <td><?php echo ($data["id"]); ?></td>
                                <td><?php echo ($data["email"]); ?></td>
                                <td><?php echo ($data["host"]); ?></td>
                                <td><?php echo date('Y-m-d H:i:s',$data['logintime']);?></td>
                            </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                        <!--<script src="/WikeWechat/Public/Visual_Admin/js/jquery-1.11.2.min.js"></script>-->
                        </tbody>
                    </table>
                    <br>
                    <center><div class="pages"><?php echo ($page); ?></div></center><br>
