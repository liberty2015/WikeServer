...
<div class="wike-content-container">
 ...
 echo $course['class']['type']; ?>
        ...
        <td>
        <?php
 $level=$course['class']['clevel']; switch($level){ case 0:echo "初级";break; case 1:echo "中级";break; case 2:echo "高级";break; } ?>
        </td>
        </tr>
        <tr>
        <td>描述：</td>
 ...
 echo $course['class']['description']; ?>
        ...
        <td>
        <div id="img">
        <img id="imgCover" src="http://wikewechat-wike.stor.sinaapp.com/<?php
 echo $course['class']['pdev']; ?>" name="preView">
        </div>
        </td>
        </tr> -->
        <tr>
        ...
        <td>
            <?php
 $len=count($course['chapter']); for($i=0;$i<$len;$i++){ $chapter=$course['chapter'][$i]; echo "<a href='/wikewechat/Admin/Course/checkChapter/cid/".$chapter['cid']."/chid/".$chapter['id']."'>".$chapter['chname']."</a>"; echo "<br/>"; } ?>
        </td>
        </tr>
        <tr>
            <td>试题：</td>
