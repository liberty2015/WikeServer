        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered">
                <tbody>
                    <tr>
                        <td>No.</td>
                        <td><?php echo ($userinfo[0]['id']); ?></td>
                    </tr>
                    <tr>
                        <td>Name:</td>
                        <td><?php echo ($userinfo[0]['name']); ?></td>
                    </tr>
                    <tr>
                        <td>Sex:</td>
                        <td><?php echo ($userinfo[0]['sex']); ?></td>
                    </tr>
                    <tr>
                        <td>Job:</td>
                        <td><?php echo ($userinfo[0]['job']); ?></td>
                    </tr>
                    <tr>
                        <td>Email:</td>
                    ...
                    <tr>
                        <td>Password</td>
                        <td><?php echo ($userinfo[0]['password']); ?></td>
                    </tr>
                    <tr>
                        <td>LastLoginTime</td>
                        <td><?php echo date('Y-m-d H:i:s',$userinfo[0]['logintime']);?></td>
                    </tr>
                    <tr>
                        <td>Access:</td>
                        <td><?php echo ($userinfo[0]['remark']); ?></td>
                    </tr>
                    <tr>
                        <td>Status</td>
                        <td><?php if($userinfo[0]['status'] == 1): ?>启用
                            <?php elseif($userinfo[0]['satus'] == 0): ?>禁用<?php endif; ?>
                        </td>
                    </tr>
                <tr>
                    <td>Describtion</td>
                    <td><p><?php echo ($userinfo[0]['describtion']); ?></p></td>
                </tr>
                </tbody>
            </table>
        </div>
