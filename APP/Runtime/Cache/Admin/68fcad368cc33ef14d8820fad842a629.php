        ...
        <div class="templatemo-content-widget white-bg col-2">
            ...
            <div class="table-responsive">
                ...
                <table class="table table-striped table-bordered">
                        ...
                        <tr>
                            <td>No.</td>
                            <td><?php echo ($userinfo[0]['id']); ?><input name="user[id]" type="hidden" value="<?php echo ($userinfo[0]['id']); ?>"></td>
                        </tr>
                        <tr>
                            <td>Name:</td>
                            <td><input type="text" value="<?php echo ($userinfo[0]['name']); ?>" name="user[name]"></td>
                        </tr>
                        <tr>
                            <td>Sex:</td>
                            <td><input type="text" value="<?php echo ($userinfo[0]['sex']); ?>" name="user[sex]"></td>
                        </tr>
                        <tr>
                            <td>Job:</td>
                            <td><input type="text" value="<?php echo ($userinfo[0]['job']); ?>" name="user[job]"></td>
                        </tr>
                        <tr>
                            <td>Email:</td>
                            <td><input type="text" value="<?php echo ($userinfo[0]['email']); ?>" name="user[email]"></td>
                        </tr>
                        <!--<tr>-->
                        <!--<td>LastLoginTime</td>-->
                        <!--<td><input type="text" value="<?php echo date('Y-m-d H:i:s',$userinfo[0]['logintime']);?>"></td>-->
                        <!--</tr>-->
                        <tr>
                            <td>Access:</td>
                            <td>
                            ...
                            <!--<td><input type="" value="<?php echo ($userinfo[0]['remark']); ?>"></td>-->
                        </tr>
                        <tr>
                            <td>Status</td>
                            <td>
                                <select size="1" id="status" name="user[status]">
                                    <!--<?php if($userinfo[0]['status'] == 1): ?>-->
                                    <!--<option selected>启用</option>-->
                                    <!--<option>禁用</option>-->
                                    <!--<?php elseif($userinfo[0]['status'] == 0): ?><option>启用</option><option selected>禁用</option>-->
                                    <!--<?php endif; ?>-->
                                    <option>启用</option>
                                    <option>禁用</option>
                                </select>
...
<script>
    ...
    for(var i=0;i<options.length;i++){
        if(options[i].innerHTML=="<?php echo ($userinfo[0]['remark']); ?>"){
            options[i].selected=true;
        }
    }
    var length=options.length;
    var status=<?php echo ($userinfo[0]['status']); ?>;
    if(<?php echo ($userinfo[0]['status']); ?>==1){
    options[length-2].selected=true;
    }else if(<?php echo ($userinfo[0]['status']); ?>==0){
